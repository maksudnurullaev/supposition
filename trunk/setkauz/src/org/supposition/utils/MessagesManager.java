...
public final class MessagesManager {
	...
	private static WebApplicationContext _wac = ContextLoader.getCurrentWebApplicationContext();
	
	private static TextManager _textManager = (TextManager) _wac.getBean(Constants._beans_text_manager);
	
	
	// *** TEXT MANAGER part ****
	public static String getText(String inKey){
		return _textManager.getTextByKey(inKey, SessionManager.getSessionLocale());
	}
	
	// *** MESSAGE SENDER part ****
	public static boolean hasMessageByKey(String inKey){
		return _textManager.hasKey(inKey, SessionManager.getSessionLocale());
	}
